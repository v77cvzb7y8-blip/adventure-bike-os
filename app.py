...
UA = "AdventureBikeOS-MVP/0.60 (prototype; GitHub: v77cvzb7y8-blip/adventure-bike-os)"
...
@app.get("/")
def home():
    return jsonify(service="Adventure Bike OS API", status="ok", version="0.60-bike-fit-terrain-icons-8.0.0")
