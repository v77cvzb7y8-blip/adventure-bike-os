...
UA = "AdventureBikeOS-MVP/0.15 (prototype; GitHub: v77cvzb7y8-blip/adventure-bike-os)"
...
@app.get("/")
def home():
    return jsonify(service="Adventure Bike OS API", status="ok", version="0.15-pdf-graphics-7.2.1")
